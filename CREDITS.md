...
### Enemy boss model (`assets/models/robots/quaternius_heavy.glb`)
**"Animated Robot"** by **Quaternius** (https://quaternius.com), via
https://poly.pizza/m/QCm7qe9uNJ — rigged/animated, used for the TERMINATOR
